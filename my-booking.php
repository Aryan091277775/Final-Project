...
<head>
  <title>Brian Car Rent - My Booking</title>
  <!-- Bootstrap CSS -->
        ...
        <div class="container">
          <div class="user_profile_info gray-bg padding_4x4_40">
            ...
            <div class="dealer_info">
              <?php if (!empty($result->FullName) || !empty($result->Address) || !empty($result->City) || !empty($result->Country)) { ?>
              ...
              <?php } else { ?>
                <p>You have not entered your info yet</p>
              <?php } ?>
